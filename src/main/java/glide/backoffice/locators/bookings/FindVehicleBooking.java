...
public class FindVehicleBooking {
	...
	/**
	 * This will find radioButton Round trip element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By divTagCheckRoundTripFindVehicleBooking= By.xpath(".//input[@id='tripType_option_roundTrip']/..");
	
	/**
	 * This will find RadioButton One-Way element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By divTagCheckOneWayFindVehicleBooking= By.xpath(".//input[@id='tripType_option_oneWayTrip']/..");
		
	/**
	 * This will find Input tag start Address element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	...
	/**
	 * This will find Start address element popup in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By liTagStartAddressPopupFindVehicleBooking(String replacementText) {
		String text=".//*[@class='geosuggest__suggests']//li[text()='testCompanySite']";
		return By.xpath(text.replace("xxxx", replacementText));
	}
	
	/**
	 * This will find  start date input element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By inputTagStartDateFindVehicleBooking= By.xpath(".//input[starts-with(@id,'pickupDate')]");
	
	/**
	 * This will find start calender popup element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By divTagStartDatePopupFindVehicleBooking= By.xpath("/html/body/div[2]/div/div[1]/div");
	
	/**
	 * This will find start date hour element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By selectTagStartHourFindVehicleBooking= 
			By.xpath(".//div[@class='boxedSelectBlock']//select[@name='pickupDateHour']");
	
	/**
	 * This will find start date minute element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By selectTagStartMinuteFindVehicleBooking= 
			By.xpath(".//div[@class='boxedSelectBlock']//select[@name='pickupDateMin']");
	
	/**
	 * This will find calendar pop for end date element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By divTagEndDatePopupFindVehicleBooking= By.xpath("html/body/div[3]/div/div[1]/div");
	/**
	 * This will find end date input element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By inputTagEndDateFindVehicleBooking= By.xpath(".//input[starts-with(@id,'returnDate')]");
	

	/**
	 * This will find  end date hour element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By selectTagEndHourFindVehicleBooking= By.xpath(".//div[@class='boxedSelectBlock']//select[@name='returnDateHour']");
	

	/**
	 * This will find end date minute element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By selectTagEndMinuteFindVehicleBooking= By.xpath(".//div[@class='boxedSelectBlock']//select[@name='returnDateMin']");
	

	/**
	 * This will find Search button element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	...
	/**
	 * This will find confirm button element in Bookings-->Create Booking--> Find member-->Fine vehicle
	...
	/**
	 * This will find Paid Check Box element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By divTagPaidCheckBoxFindVehicleBooking= By.xpath(".//div[@class='checkboxMaterial']/div/div/div[1]");
	
	
	/**
	 * This will find Custom field Element element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	...
	/**
	 * This will find Save Button element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
	public final By buttonTagSaveFindVehicleBooking= By.xpath(".//button[@class='ekButton addBookingConfirmationForm_button']");
	

	/**
	 * This will find Cancel button element in Bookings-->Create Booking--> Find member-->Fine vehicle
	 */
