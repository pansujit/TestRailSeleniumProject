...
/**
 * This class contains all the locators in the page back user edit and Some of the field also equally used by 
 * {@link BackUsersCreate} class
 * 
 * 
 * @author sujitpandey
 *
 */
public class BackUserEdit {
